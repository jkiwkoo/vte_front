const English = {
  ...
  glass: {
    ...
    '3': {
      ...
      description6:
        'Think curved, glass surfaces that respond to touch directly',
  ...
  flow: {
    ...
    subTitle2:
      'We produce a variety of glass materials and special glass materials.',
  ...
  products: {
    ...
    '1': {
      ...
      description:
        "VTE's advanced optics always steps ahead to lead the next-generation of consumer devices. The use of aspherics in an optical system achieves various advantages such as correction of spherical aberration, system miniaturization and weight reduction. Regarding optical design, the use of an aspherical lenses allows the optical system to be reduced in size and weight.",
      description2:
        'VTE is specialized in the production of aspheric lenses. A finished polished lens has no pores or cracks on a surface as well as the desired shape accuracy and surface quality because we process double-inspection and finishing for more precision.',
    },
    '2': {
      '1': 'TSP - M',
      '2': 'OCA',
      ...
      description:
        "VTE's tempered glass can be applied to various ways in our life style. We believe that glass contributes to showing high-end quality in general home appliances such as oven and refrigerator.",
      description2:
        "VTE's tempered glass can be applied to kiosk and advanced interactive display.",
    },
    '3': {
      '1': 'AF Coating',
      '2': 'Glass',
      ...
      description:
        "VTE's takes several steps ahead towords to contribute to global automotive technology. We manufacture durable and optically advanced cover glass solution specifically designed for auto interior applications.",
      description2:
        "VTE's glass solution for automotive is also applied to head-up display.",
    },
    '4': {
      '1': 'Glass',
      '2': 'Siver Coating',
      ...
      description:
        'VTE manufactures a Low-E glass especially for oven doors with low-emissivity coating, which allows a high flexibility in the design phase of the oven by the customer.',
      description2:
        "VTE's Low-E glass makes it easy to have heat resistance even at 1000 degrees. This special glass with excellent insulation makes incredible energy efficiency.",
    },
  },
  support: {
    title: 'SUPPORT',
  ...
  footer: {
    ...
    fax: ': 054-441-4568',
    korea:
      ': 22-11, Indong 21-gil, Gumi-si, Gyeongsangbuk-do, Republic of Korea',
    china:
      ': NO.888 West of Renmin Rd. In West Development Zone Sheyang County 224300 Yancheng City, Jiangsu Prov.China',
    copyright: 'Copyright©VTE CORP. ALL RIGHTS RESERVED.',
  },
};
